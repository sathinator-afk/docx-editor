...
In Vue the same control is a `comments-sidebar-open` prop plus a `comments-sidebar-open-change` event: `<DocxEditor :comments-sidebar-open="sidebarOpen" @comments-sidebar-open-change="sidebarOpen = $event" />`.
